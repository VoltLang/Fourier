...
enum CINDEX_VERSION_MINOR = 32;

i32 CINDEX_VERSION_ENCODE(i32 major, i32 minor)
{
  return ((major) * 10000) + ((minor) * 1);
}

enum CINDEX_VERSION = #run CINDEX_VERSION_ENCODE(
 ...
 */
void clang_CXIndex_setGlobalOptions(CXIndex, u32 options);
 ...
 */
u32 clang_CXIndex_getGlobalOptions(CXIndex);
 ...
 */
u32 clang_equalLocations(CXSourceLocation loc1,
 ...
 */
u32 clang_equalRanges(CXSourceRange range1,
 ...
 */
u32 clang_getNumDiagnosticsInSet(CXDiagnosticSet Diags);
 ...
 * translation unit.
 */
u32 clang_getNumDiagnostics(CXTranslationUnit Unit);
 ...
 */
u32 clang_defaultDiagnosticDisplayOptions();
 ...
 */
u32 clang_getDiagnosticCategory(CXDiagnostic);
 ...
 */
//CXString clang_getDiagnosticCategoryName(u32 Category);
 ...
 * diagnostic.
 */
u32 clang_getDiagnosticNumRanges(CXDiagnostic);
 ...
 * given diagnostic.
 */
u32 clang_getDiagnosticNumFixIts(CXDiagnostic Diagnostic);
 ...
 */
u32 clang_defaultEditingTranslationUnitOptions();
...
CXErrorCode clang_parseTranslationUnit2FullArgv(
    ...
    CXUnsavedFile* unsaved_files, u32 num_unsaved_files,
    u32 options, CXTranslationUnit *out_TU);
 ...
 */
u32 clang_defaultSaveOptions(CXTranslationUnit TU);
 ...
 * to the next.
 */
u32 clang_defaultReparseOptions(CXTranslationUnit TU);
...
enum CXCursorKind {
   ...
   * struct count {
   *   static const u32 value = sizeof...(Types);
   * };
   * \endcode
   */
 ...
 */
u32 clang_equalCursors(CXCursor, CXCursor);
 ...
 */
u32 clang_isDeclaration(CXCursorKind);
 ...
 */
u32 clang_isReference(CXCursorKind);

/**
 * \brief Determine whether the given cursor kind represents an expression.
 */
u32 clang_isExpression(CXCursorKind);

/**
 * \brief Determine whether the given cursor kind represents a statement.
 */
u32 clang_isStatement(CXCursorKind);

/**
 * \brief Determine whether the given cursor kind represents an attribute.
 */
u32 clang_isAttribute(CXCursorKind);

/**
 * \brief Determine whether the given cursor kind represents an invalid
 * cursor.
 */
u32 clang_isInvalid(CXCursorKind);

/**
 * \brief Determine whether the given cursor kind represents a translation
 * unit.
 */
u32 clang_isTranslationUnit(CXCursorKind);

/***
 * \brief Determine whether the given cursor represents a preprocessing
 * element, such as a preprocessor directive or macro instantiation.
 */
u32 clang_isPreprocessing(CXCursorKind);
  
/***
 * \brief Determine whether the given cursor represents a currently
 *  unexposed piece of the AST (e.g., CXCursor_UnexposedStmt).
 */
u32 clang_isUnexposed(CXCursorKind);
...
*/
u32 clang_CXCursorSet_contains(CXCursorSet cset,
                                                   CXCursor cursor);
...
*/
u32 clang_CXCursorSet_insert(CXCursorSet cset,
                                                 CXCursor cursor);
 ...
 */
i64 clang_getEnumConstantDeclValue(CXCursor C);

/**
 * \brief Retrieve the integer value of an enum constant declaration as an u32
 *  long long.
 *
 ...
 * must be verified before calling this function.
 */
u64 clang_getEnumConstantDeclu32Value(CXCursor C);
 ...
 */
CXCursor clang_Cursor_getArgument(CXCursor C, u32 i);
 ...
 */
i64 clang_Cursor_getTemplateArgumentValue(CXCursor C,
                                                               u32 I);

/**
 * \brief Retrieve the value of an Integral TemplateArgument (of a function
 *  decl representing a template specialization) as an u32 long long.
 *
 * It is undefined to call this function on a CXCursor that does not represent a
 * FunctionDecl or whose I'th template argument is not an integral value.
 *
 ...
 * For I == 0, this function's behavior is undefined.
 */
u64 clang_Cursor_getTemplateArgumentu32Value(
    CXCursor C, u32 I);
 ...
 *          zero otherwise.
 */
u32 clang_equalTypes(CXType A, CXType B);
 ...
 * different level.
 */
u32 clang_isConstQualifiedType(CXType T);
 ...
 * a different level.
 */
u32 clang_isVolatileQualifiedType(CXType T);
 ...
 * different level.
 */
u32 clang_isRestrictQualifiedType(CXType T);
 ...
 */
u32 clang_isFunctionTypeVariadic(CXType T);
 ...
 * -1 is returned.
 */
i64 clang_getNumElements(CXType T);
 ...
 */
i64 clang_getArraySize(CXType T);
 ...
 */
i64 clang_Type_getAlignOf(CXType T);
 ...
 *   returned.
 */
i64 clang_Type_getSizeOf(CXType T);
 ...
 */
i64 clang_Type_getOffsetOf(CXType T, const(char)* S);
 ...
 *   CXTypeLayoutError_InvalidFieldName is returned.
 */
i64 clang_Cursor_getOffsetOfField(CXCursor C);

/**
 * \brief Determine whether the given cursor represents an anonymous record
 * declaration.
 */
u32 clang_Cursor_isAnonymous(CXCursor C);
 ...
 *   bitfield.
 */
u32 clang_Cursor_isBitField(CXCursor C);

/**
 * \brief Returns 1 if the base class specified by the cursor with kind
 *   CX_CXXBaseSpecifier is virtual.
 */
u32 clang_isVirtualBase(CXCursor);
 ...
 */
u32 clang_getNumOverloadedDecls(CXCursor cursor);
 ...
 */
u32 clang_visitChildren(CXCursor parent,
 ...
 */
u32 clang_visitChildrenWithBlock(CXCursor parent,
 ...
 */
u32 clang_isCursorDefinition(CXCursor);
 ...
 */
u32 clang_Cursor_getObjCPropertyAttributes(CXCursor C,
                                                             u32 reserved);
 ...
 */
u32 clang_Cursor_getObjCDeclQualifiers(CXCursor C);
 ...
 */
u32 clang_Cursor_isObjCOptional(CXCursor C);

/**
 * \brief Returns non-zero if the given cursor is a variadic function or method.
 */
u32 clang_Cursor_isVariadic(CXCursor C);
 ...
 */
u32 clang_Module_getNumTopLevelHeaders(CXTranslationUnit,
                                                           CXModule Module);
 ...
 */
u32 clang_CXXField_isMutable(CXCursor C);

/**
 * \brief Determine if a C++ member function or member function template is
 * pure virtual.
 */
u32 clang_CXXMethod_isPureVirtual(CXCursor C);

/**
 * \brief Determine if a C++ member function or member function template is 
 * declared 'static'.
 */
u32 clang_CXXMethod_isStatic(CXCursor C);
 ...
 */
u32 clang_CXXMethod_isVirtual(CXCursor C);

/**
 * \brief Determine if a C++ member function or member function template is
 * declared 'const'.
 */
u32 clang_CXXMethod_isConst(CXCursor C);
...
void clang_executeOnThread(void function(void*) func, void *user_data,
                                          u32 stack_size);
 ...
 */
alias CXCompletionString = CXCompletionStringImpl*;
struct CXCompletionStringImpl {}
 ...
 */
u32 clang_defaultCodeCompleteOptions();
 ...
 */
u32 clang_codeCompleteGetNumDiagnostics(CXCodeCompleteResults *Results);
 ...
 */
u64 clang_codeCompleteGetContexts(
 ...
 */
void clang_toggleCrashRecovery(u32 isEnabled);
 ...
 */
alias CXRemapping = CXRemappingImpl*;
struct CXRemappingImpl {}
 ...
 */
u32 clang_remap_getNumFiles(CXRemapping);
 ...
 * is associated with.
 */
void clang_remap_getFilenames(CXRemapping, u32 index,
 ...
 */
alias CXIdxClientFile = CXIdxClientFileImpl*;
struct CXIdxClientFileImpl {}

/**
 * \brief The client's data object that is associated with a semantic entity.
 */
alias CXIdxClientEntity = CXIdxClientEntityImpl*;
struct CXIdxClientEntityImpl {}

/**
 * \brief The client's data object that is associated with a semantic container
 * of entities.
 */
alias CXIdxClientContainer = CXIdxClientContainerImpl*;
struct CXIdxClientContainerImpl {}

/**
 * \brief The client's data object that is associated with an AST file (PCH
 * or module).
 */
alias CXIdxClientASTFile = CXIdxClientASTFileImpl*;
struct CXIdxClientASTFileImpl {}
...
struct IndexerCallbacks {
   ...
   * the AST file.
   */
  CXIdxClientASTFile function(CXClientData client_data,
 ...
 * translation units.
 */
alias CXIndexAction = CXIndexActionImpl*;
struct CXIndexActionImpl {}
...
int clang_indexSourceFileFullArgv(
    ...
    u32 index_callbacks_size, u32 index_options,
    const(char)* source_filename, const(char*)* command_line_args,
    int num_command_line_args, CXUnsavedFile* unsaved_files,
    u32 num_unsaved_files, CXTranslationUnit *out_TU, u32 TU_options);
 ...
 */
u32 clang_Type_visitFields(CXType T,

/*==- clang-c/BuildSystem.h - Utilities for use by build systems -*- Volt -*-=*\
|*                                                                            *|
...
|*                                                                            *|
\*===----------------------------------------------------------------------===*/
module lib.clang.c.BuildSystem;
 ...
 */
u64 clang_getBuildSessionTimestamp();
...
clang_VirtualFileOverlay_create(u32 options);
 ...
 */
CXErrorCode
clang_VirtualFileOverlay_writeToBuffer(CXVirtualFileOverlay, u32 options,
                                       char** out_buffer_ptr,
                                       u32* out_buffer_size);
...
clang_ModuleMapDescriptor_create(u32 options);
 ...
 */
CXErrorCode
clang_ModuleMapDescriptor_writeToBuffer(CXModuleMapDescriptor, u32 options,
                                        char **out_buffer_ptr,
                                        u32 *out_buffer_size);

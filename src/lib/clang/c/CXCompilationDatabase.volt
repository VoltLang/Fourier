/*===- clang-c/CXCompilationDatabase.h - Compilation database --*- Volt -*-===*\
|*                                                                            *|
...
|*                                                                            *|
\*===----------------------------------------------------------------------===*/
module lib.clang.c.CXCompilationDatabase;
 ...
 */
CXCompileCommand
clang_CompileCommands_getCommand(CXCompileCommands, u32 I);
 ...
 */
CXString
clang_CompileCommand_getArg(CXCompileCommand, u32 I);
 ...
 */
CXString
clang_CompileCommand_getMappedSourcePath(CXCompileCommand, u32 I);

/**
 * \brief Get the I'th mapped source content for the compiler invocation.
 */
CXString
clang_CompileCommand_getMappedSourceContent(CXCompileCommand, u32 I);
